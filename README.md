Привет! 
Меня зовут Андрей Шаталов, я начинающий аналитик данных с большим пратичесикм опытом работы в финансовом и реальном секторе экономики. 
...
Электронная почта: andreyshatalov1@gmail.com
